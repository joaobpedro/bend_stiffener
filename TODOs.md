...
# BEND STIFFENER OPTIMIZER
  ...
  - [x] implement optimization for a given set of load cases, minimize the strain distance.
  ...
  - [x] the solution is not converging when we have high angles
  - [x] FIXME: !!! identify where the problem is - strain is not ok, but the is the equations solution?
  - [x] NOTE: there is a problem with the integration, not just the strain calculation
- [x]   this was a problem with the pair